...
CATEGORY_KEYWORDS: dict[str, tuple[str, ...]] = {
    "disease": (
        "disease", "fungus", "fungal", "blight", "rust", "rot", "wilt",
        "mildew", "mosaic", "spots", "lesion", "bimari", "rog",
    ),
    "pest": (
        "pest", "insect", "bug", "locust", "aphid", "borer", "caterpillar",
        "worm", "mite", "whitefly", "termite", "keeda", "keede", "sundi",
    ),
    "weather": (
        "weather", "storm", "frost", "heatwave", "heat wave", "flood",
        "hail", "cyclone", "drought", "unseasonal", "mausam",
    ),
    "irrigation": (
        "water", "irrigation", "irrigate", "drip", "sprinkler", "canal",
        "borewell", "watering", "pani", "sinchai",
    ),
    "soil": (
        "soil", "fertilizer", "fertiliser", "nutrient", "nitrogen", "urea",
        "compost", "manure", "ph ", "acidic", "mitti", "khaad", "khad",
    ),
    "market": (
        "price", "sell", "selling", "market", "mandi", "msp", "rate",
        "profit", "buyer", "bhav", "daam",
    ),
    "scheme": (
        "scheme", "subsidy", "loan", "insurance", "yojana", "sarkar",
        "government", "kcc", "credit card", "pm-kisan", "pmkisan", "benefit",
    ),
}
...
PRIORITY: tuple[str, ...] = (
    "disease", "pest", "weather", "irrigation", "soil", "market", "scheme",
)
...
URGENT_WORDS: tuple[str, ...] = (
    "urgent", "emergency", "dying", "died", "spreading", "spread fast",
    "rapidly", "immediately", "whole field", "entire field", "everywhere",
    "all my", "overnight", "turning yellow", "wiped out",
)
